...
import { ShieldCheck, HardDrive, Cpu, Terminal, Key, FileCode } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      id="vscode-sidebar"
      className="relative flex select-none shrink-0 h-full border-r z-10 transition-all duration-75"
      style={{
        width: `${width}px`,
